...
var tests = []struct {
	...
	{RRule: "RRULE"},            // TODO TEST VALUE
	{RRule: "RRULE:FREQ=DAILY"}, // TODO TEST VALUE
	...
	// {RRule: "RRULE:FREQ=YEARLY;UNTIL=20000131T140000Z;"},
	// {RRule: "RRULE:FREQ=DAILY;UNTIL=20000131T140000Z;BYMONTH=1"},
	// {RRule: "RRULE:FREQ=WEEKLY;COUNT=10"},
	// {RRule: "RRULE:FREQ=WEEKLY;UNTIL=19971224T000000Z"},
	// {RRule: "RRULE:FREQ=WEEKLY;INTERVAL=2;WKST=SU"},
	// {RRule: "RRULE:FREQ=WEEKLY;UNTIL=19971007T000000Z;WKST=SU;BYDAY=TU,TH"},
	// {RRule: "RRULE:FREQ=WEEKLY;COUNT=10;WKST=SU;BYDAY=TU,TH"},
	// {RRule: "RRULE:FREQ=WEEKLY;INTERVAL=2;UNTIL=19971224T000000Z;WKST=SU;"},
	// {RRule: "RRULE:FREQ=WEEKLY;INTERVAL=2;COUNT=8;WKST=SU;BYDAY=TU,TH"},
	// {RRule: "RRULE:FREQ=MONTHLY;COUNT=10;BYDAY=1FR"},
	// {RRule: "RRULE:FREQ=MONTHLY;UNTIL=19971224T000000Z;BYDAY=1FR"},
	// {RRule: "RRULE:FREQ=MONTHLY;INTERVAL=2;COUNT=10;BYDAY=1SU,-1SU"},
	// {RRule: "RRULE:FREQ=MONTHLY;COUNT=6;BYDAY=-2MO"},
	// {RRule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=-3"},
	// {RRule: "RRULE:FREQ=MONTHLY;COUNT=10;BYMONTHDAY=2,15"},
	// {RRule: "RRULE:FREQ=MONTHLY;COUNT=10;BYMONTHDAY=1,-1"},
	// {RRule: "RRULE:FREQ=MONTHLY;INTERVAL=18;COUNT=10;BYMONTHDAY=10,11,12,"},
	// {RRule: "RRULE:FREQ=MONTHLY;INTERVAL=2;BYDAY=TU"},
	// {RRule: "RRULE:FREQ=YEARLY;COUNT=10;BYMONTH=6,7"},
	// {RRule: "RRULE:FREQ=YEARLY;INTERVAL=2;COUNT=10;BYMONTH=1,2,3"},
	// {RRule: "RRULE:FREQ=YEARLY;INTERVAL=3;COUNT=10;BYYEARDAY=1,100,200"},
	// {RRule: "RRULE:FREQ=YEARLY;BYDAY=20MO"},
	// {RRule: "RRULE:FREQ=YEARLY;BYWEEKNO=20;BYDAY=MO"},
	// {RRule: "RRULE:FREQ=YEARLY;BYMONTH=3;BYDAY=TH"},
	// {RRule: "RRULE:FREQ=YEARLY;BYDAY=TH;BYMONTH=6,7,8"},
	// {RRule: "RRULE:FREQ=MONTHLY;BYDAY=FR;BYMONTHDAY=13"},
	// {RRule: "RRULE:FREQ=MONTHLY;BYDAY=SA;BYMONTHDAY=7,8,9,10,11,12,13"},
	// {RRule: "RRULE:FREQ=YEARLY;INTERVAL=4;BYMONTH=11;BYDAY=TU;"},
	// {RRule: "RRULE:FREQ=MONTHLY;COUNT=3;BYDAY=TU,WE,TH;BYSETPOS=3"},
	// {RRule: "RRULE:FREQ=MONTHLY;BYDAY=MO,TU,WE,TH,FR;BYSETPOS=-2"},
	// {RRule: "RRULE:FREQ=HOURLY;INTERVAL=3;UNTIL=19970902T170000Z"},
	// {RRule: "RRULE:FREQ=MINUTELY;INTERVAL=15;COUNT=6"},
	// {RRule: "RRULE:FREQ=MINUTELY;INTERVAL=90;COUNT=4"},
	// {RRule: "RRULE:FREQ=DAILY;BYHOUR=9,10,11,12,13,14,15,16;BYMINUTE=0,20,40"},
	// {RRule: "RRULE:FREQ=MINUTELY;INTERVAL=20;BYHOUR=9,10,11,12,13,14,15,16"},
...
func TestParse(t *testing.T) {
	for _, test := range tests {
		t.Run(test.RRule, func(t *testing.T) {
			rule, err := recurrence.ParseRRule(test.RRule)
			assert.NoError(t, err, fmt.Sprintf("Rule=%v", rule))
		})
	}
}
